...
<section class="about-section about-2 pt-50 pb-50" id="about-2">
        <div class="container">
...
Cookie is a piece of software code that an internet web site sends to your browser when you access information at that site. This site does not use cookies.
</p>
<p>
<strong>Email Management</strong>
Your email address will only be recorded if you choose to send/receive a message. It will only be used for the purpose for which you have provided it and will not be added to a mailing list. Your email address will not be used for any other purpose, and will not be disclosed, without your consent.
</p>
<p>
If at any time you believe the principles referred to in this privacy policy have not been followed, or have any other comments on these principles, please notify the Project Director, Passport Seva Project at:
    </p>
<p>
